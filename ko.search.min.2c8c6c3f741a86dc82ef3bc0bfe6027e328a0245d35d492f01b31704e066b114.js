...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.bac6f8da895dc541d9a4c10777e397ea4cad71d3775e58c7878539685f9a8d5f.js',function(){input.required=false;search();});}
