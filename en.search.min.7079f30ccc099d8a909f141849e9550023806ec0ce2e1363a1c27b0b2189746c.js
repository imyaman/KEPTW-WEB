...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6589ae2ff9bfa07c6cfe722a790424e49ef28ee63a7f0fdcb879354735038bd4.js',function(){input.required=false;search();});}
