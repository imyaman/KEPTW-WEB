...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.cab1f12833156ba05a61d11c8cf352e42572d9a1e71f6453be980d8aee0490a9.js',function(){input.required=false;search();});}
