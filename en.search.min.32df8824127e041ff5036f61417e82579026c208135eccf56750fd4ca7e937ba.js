...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.aeeb1f157150efea7189249819f842babb1d4c2a5bdcb2144173ed826c3027f7.js',function(){input.required=false;search();});}
