...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.53028158185eee84f308883016835a6202e5960979ffbb14053b9c9106cd289f.js',function(){input.required=false;search();});}
