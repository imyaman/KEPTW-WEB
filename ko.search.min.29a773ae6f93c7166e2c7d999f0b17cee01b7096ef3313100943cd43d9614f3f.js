...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.f260855205ea39f368b325bf38225199635dc7880f2a0d7592b6e0e50d5495ed.js',function(){input.required=false;search();});}
