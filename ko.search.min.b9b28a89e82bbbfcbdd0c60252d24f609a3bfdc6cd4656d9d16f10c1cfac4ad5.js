...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.b323c0d7532913710c399128583060adb4ae8ee9b8293e97af4bba7cb0c38a8a.js',function(){input.required=false;search();});}
