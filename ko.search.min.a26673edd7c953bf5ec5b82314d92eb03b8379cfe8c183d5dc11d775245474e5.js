...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ko.search-data.min.364470b9fd48c12fd2d78f4c4847cb148aa655a17adc4d37cb15b4a685a0b0a8.js',function(){input.required=false;search();});}
