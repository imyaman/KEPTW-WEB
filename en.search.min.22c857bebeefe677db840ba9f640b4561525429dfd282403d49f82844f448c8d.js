...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ac2480bfbf6be7dd0b415fff131e8c8225de758b94287852e0f21ebdeca003e3.js',function(){input.required=false;search();});}
